...
const qaList: QAItem[] = [
  ...
  {
    q: '为什么我好像不开VPN连不上？',
    a: '由于内容特殊性，LINPX的服务器和域名都在国外。\n大部分地区能够正常访问，但是站长工具的ping测试结果显示总是有一些区域无法连接。\n虽然做了一些补救措施，但问题仍存在。\n欢迎加群反馈所在地区，以供更好统计测试。',
  },
  {
    q: '如何成为推荐作者？有什么条件吗？',
    a: '首先需要有一个发表了数篇小说（越多越好）的pixiv账号，然后加qq群576268549反馈即可。',
  },
  {
    q: '推荐作者是怎么排序的？',
