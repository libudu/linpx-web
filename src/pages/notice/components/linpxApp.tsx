...
const qaList = [
  {
    ...
    a: (
      <>
        ...
        <div>
          本来是不打算做的，但是许多国产安卓手机浏览器屏蔽了 linpx
          的网址，严重影响了用户体验。这个 App 正是给更喜欢使用 App 或者浏览器中
          linpx 被屏蔽的用户提供一个额外的选择。
        </div>
        <div>
          另外在 linpx 链接被 QQ 全面屏蔽后，分享 Linpx App
  ...
  {
    q: '有考虑开发 IOS 平台的应用吗？',
    a: '暂时不考虑。因为站长手里没有果子手机用来调试，果子系统的应用安装更加严格，并且 Safari 浏览器目前还没有拦截 Linpx 的域名，可以正常通过浏览器访问。',
  },
];
